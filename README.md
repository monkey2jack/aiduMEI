...
| 全轴齐备 | 1111 全绿 —— **推导值，从未实测**：跳过有九条互不相干的轴，手上没有一台机器同时满足全部九条 |
...
> **两边各缺一条，所以「1111 全绿」我们从来没有实测过**，它只是推导值。上一版 README 把它写成
...
> `有宿主：1111 passed` **也是推导值**：1111 要九条轴同时齐备才拿得到，而我们手上没有这样一台机器。

...
| 基础安装路径 | 1810 通过 · **25 跳过** —— 只装 `requirements.txt` + `requirements-dev.txt`（**2026-09-09 干净 venv 实测**，v20.4.0 本树，Python 3.12） |
| 生产机沙箱 | **待复测**（按轴推导值为 1825/10，上一实测基线 2026-09-08 alpha 树 1803+9；换树后须生产机实机重测） |

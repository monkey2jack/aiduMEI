...
| 维度 | 现状 |
|------|------|
| 用例总数 | **1857**（`pytest --collect-only` 实测，2026-09-10，v20.5 preview 本树） |
| 独立开发机 | 1845 通过 · **12 跳过** —— **2026-09-10 实测**（v20.5 preview 本树，Python 3.12；完整 extras + 模型缓存，只缺 Hermes 宿主） |

...
- **用例总数 1743 → 1835**（`pytest --collect-only`；三方审计 P0/P1 整改在 alpha 基础上再增 23 条守卫用例）：开发机本树 2026-09-09 实测 1823+12；干净 venv 1777+35（2026-09-08 alpha 树）；生产机独立全轴 2026-09-09 本树实测 1834+1；生产机独立沙箱换树后**待复测**（按轴推导 1827/9，上一实测基线 1803+9 @2026-09-08 alpha 树）。

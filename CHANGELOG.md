...
## v20.3.3 (2026-09-05 · 生产小版本升级)

- 宿主 Hermes Agent 升级至 September 2026 拆解后版本，MemoryProvider 12 项宿主集成测试 100% 全绿（12 passed in 0.23s）。
- `integrations/aidumem-inject.sh` 注入超时从 2.0s 严格收紧至 1.5s，并在生产环境部署同步，防止慢调用拖累对话。
- 用例总数 1728 → 1728（1728 通过率验证，全绿零回归）。

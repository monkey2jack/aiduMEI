...
- **用例总数 1743 → 1812**（`pytest --collect-only`，2026-09-08 实测）：本轮 P0/P1/P2 守卫用例净增 69 条。README 双语数字表**五行全部实测**（2026-09-08 同一天、同一棵树）：开发机 1800+12、干净 venv 1777+35、生产机独立沙箱 1803+9、生产机独立全轴 venv 1812+0；沙箱与全轴两行不再是按轴推导值。

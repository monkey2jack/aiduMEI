...
自动把 Cursor 中的代码变更存入 aiduMEI 的 Raw Drawer（原味抽屉），让 AI 能记住你写过的代码。
...
This stores your code into aiduMEI's Raw Drawer for long-term memory.
```
...
| 变量 | 默认值 | 说明 |
|------|--------|------|
| `AIDUMEM_URL` | `http://127.0.0.1:8767` | aiduMEI API 地址 |

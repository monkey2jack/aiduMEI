...
| All axes present | 1254 all green · 0 skipped is the axis-derived target for this hardening tree — **not claimed** until this round's production-sandbox run; the latest full-axis measurement is 1232 all green (**measured on the production box, 2026-08-26**, candidate tree, total 1232 then, ten axes). Before that the row was a derived number, labelled "never measured" for several releases |
...
> production-sandbox run — the previous full-axis measurement was 1232 on 2026-08-26 (candidate tree, total 1232 then, zero skips).
